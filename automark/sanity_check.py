...
# Health
r = requests.get("http://backend:5002/")
if r.status_code != 200:
    fail("Backend health check failed")

# Students list
r = requests.get("http://backend:5002/students")
...
r = requests.get("http://backend:5002/stats")
if r.status_code != 200:
...
r2 = requests.get("http://backend:5002/students")
